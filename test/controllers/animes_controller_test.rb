...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { grade: @anime.grade, num: @anime.num, resume: @anime.resume, title: @anime.title } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { grade: @anime.grade, num: @anime.num, resume: @anime.resume, title: @anime.title } }
